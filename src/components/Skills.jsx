    ...
    <div name='experiência' className='w-full h-full bg-[#0a192f] text-gray-300'>
      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img className='w-20 mx-auto' src={ReactIcon} alt="React Ícone" />
            <p className='my-4'>React JS & Native</p>
          </div>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img src={StyledComponents} alt="Styled Component Ícone" className='p-1 w-20 mx-auto'/>
            <p className='my-4'>Styled Components</p>
          </div>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img src={Tailwind} alt="Tailwind Ícone" className='p-1 w-20 mx-auto'/>
            <p className='my-4'>Tailwind</p>
          </div>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img src={Typescript} alt="Typescript Ícone" className='p-1 w-20 mx-auto'/>
            <p className='my-4'>Typescript</p>
          </div>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <img src={Expo} alt="Expo Ícone" className='p-1 w-20 mx-auto'/>
            <p className='my-4'>Expo</p>
          </div>
          <div className='bg-[#204d91] shadow-md shadow-[#040c16] hover:scale-110 duration-500 pt-2'>
            <img src={NextJS} alt="Next Js Ícone" className='p-1 w-20 h-20 mx-auto'/>
